...
11. **Shipping Method:** The user can select a shipping method from a list of methods. Each shipping method has a single standard price (to keep things simple).
